...
//Must be a number w/label error:
    ...
    debt_types.push({ [debtType]: monthly_debt_cost, AmountOwedTotal: totalOwed })
...
//If emergency fund is more than 1k apply excess_amount automatically towards debt starting with smallest
// So this would be excess_amount - array[0] if still a positive number then excess_amount - array[1] and so on.
//Then you'll need to create a new array without the lowest debts 
